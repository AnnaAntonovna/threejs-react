  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        "plan-back": "url('/src/assets/planbg.png')",
        "web-back": "url('/src/assets/ifcjsProject.png')",
        "dynamo-back": "url('/src/assets/rebarUI.png')",
        "calc-back": "url('/src/assets/calc.png')",
        "bim-back": "url('/src/assets/bim.png')",
        "plugin-back": "url('/src/assets/plugin.png')",
        "more-back": "url('/src/assets/more.png')",
      },
    },
  },
  plugins: [],
