  ...
  return (
    ...
    >
      ...
      onClick={()=> {
        ...
        <p className='text-white text-[18px] font-bold cursos-pointer'>Anna Baranova
        <span className='sm:block hidden'> &#91; BIM Developer &#93;</span></p>
      </Link>
      ...
      <div className='sm:hidden flex flex-1 justify-end items center'>
        ...
        absolute top-20 right-0 mx-4 my-2 min-w-[140px] z-10 rounded-xl`}>
          <ul className="list-none flex justify-end justify-start flex-col
            gap-4">
            {navLinks.map((link) => (
              <li 
              key={link.id}
